...
On [CodeCrafters](https://codecrafters.io/rust) you can get some quality practice through recreating technologies from scratch in Rust (e.g Build your own BitTorrent, HTTP Server, SQLite, etc).
